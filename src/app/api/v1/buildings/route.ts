...
import { listBuildings, createBuilding } from "@/services/test-center.service";
import { buildingFilterSchema, createBuildingSchema } from "@/lib/validations/test-center";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const filters = buildingFilterSchema.parse(params);
    const result = await listBuildings(session.tenantId, filters);
